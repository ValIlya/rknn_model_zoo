...
# Example: ./convert_to_rknn.sh rk3568 fp
...
pip install torch==2.4.1 torchaudio==2.4.1 transformers==4.39.3 onnx==1.15.0
# Install rknn-toolkit2 wheel for aarch64 (Linux)
# Adjust the wheel path if you have a different version
WHEEL_PATH="/Users/ilya/code/rknn-toolkit2/rknn-toolkit2/packages/arm64/rknn_toolkit2-2.3.2-cp311-cp311-manylinux2014_aarch64.whl"
